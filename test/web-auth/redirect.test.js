...
describe('authok.WebAuth.redirect', function () {
  before(function () {
    sinon
  ...
  context('login', function () {
    ...
    it('should call CrossOriginAuthentication.login', function (done) {
      ...
      this.authok.redirect.loginWithCredentials(inputOptions, function () {
        return 'cb';
      });
    });
  });
  ...
  context('signup and login', function () {
    ...
    it('should call db-connection signup with all the options', function (done) {
      ...
      sinon.stub(this.authok, 'login').callsFake(function (options, cb) {
      ...
      this.authok.redirect.signupAndLogin({
        connection: 'the_connection',
        email: 'me@example.com',
        password: '123456',
        scope: 'openid'
  ...
  describe('authenticate', function () {
    ...
    it('should check that responseType is present', function () {
      var _this = this;
      expect(function () {
        _this.authok.authorize({ connection: 'facebook' });
    ...
    it('should redirect to logout', function () {
      ...
      expect(global.window.location).to.be(
        'https://me.authok.com/v2/logout?client_id=...&redirect_to=http%3A%2F%2Fexample.com%2Flogout'
      );
    });
  });
});
